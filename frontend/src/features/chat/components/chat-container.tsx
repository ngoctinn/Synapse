  ...
  return (
    <div className="bg-background relative flex h-full flex-col overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="bg-primary/5 animate-pulse-horizontal absolute right-0 top-0 h-[500px] w-[500px] rounded-full blur-[100px]" />
        <div className="bg-secondary/10 absolute bottom-0 left-0 h-[500px] w-[500px] rounded-full blur-[100px]" />
      </div>

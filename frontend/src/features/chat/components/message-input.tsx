  ...
  return (
    <div className="p-4 border-t border-border bg-white/50 dark:bg-card/50 backdrop-blur-sm rounded-b-xl">
      <div className="flex items-end gap-2 group p-1 rounded-xl focus-within:ring-2 focus-within:ring-primary/20 focus-within:bg-background/80 transition-all duration-200">
        <Button variant="ghost" size="icon-lg" className="text-muted-foreground hover:text-primary rounded-full hover:bg-primary/10 transition-colors mb-0.5" aria-label="Đính kèm file">
        ...
        <div className="relative flex-1">
          <Textarea
            ...
            rows={1}
          />
           <Button variant="ghost" size="icon-sm" className="absolute right-0 top-1 text-muted-foreground hover:text-primary rounded-full" aria-label="Chọn emoji">

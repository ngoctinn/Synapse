...
import { PartyPopper, Settings2, Wrench, X } from "lucide-react";
...
export function ExceptionsFilterBar({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 sm:pb-0 scrollbar-hide mask-fade-right sm:mask-none">
        {/* Date Range Picker */}

...
import type { PaginatedWaitlist, WaitlistCreateInput, WaitlistEntry } from "./model/types";
...
export async function getWaitlist(
  ...
  return executeAction("getWaitlist", async () => {
...
export async function createWaitlistEntry(data: WaitlistCreateInput) {
  return executeAction("createWaitlistEntry", async () => {
...
export async function updateWaitlistStatus(
  ...
  return executeAction("updateWaitlistStatus", async () => {
...
export async function deleteWaitlistEntry(id: string) {
  return executeAction("deleteWaitlistEntry", async () => {
...
export async function updateWaitlistEntry(_data: WaitlistCreateInput) {
  return executeAction("updateWaitlistEntry", async () => {

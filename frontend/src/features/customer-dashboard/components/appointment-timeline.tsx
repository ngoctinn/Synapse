            ...
            {layoutItems.map((app) => {
              ...
              return (
                <div
                  key={app.id}
                  className={cn(
                    "group/item focus-visible:ring-primary absolute cursor-pointer overflow-hidden rounded-md border p-2 text-xs shadow-sm transition-all hover:z-30 hover:shadow-md focus-visible:outline-none focus-visible:ring-[1.5px] md:text-sm",
                    status.bgClass,
                    status.borderClass
                  )}
                  style={{

  ...
  if (treatments.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-muted-foreground">Bạn chưa đăng ký gói liệu trình nào.</p>
      </div>
    )
  }
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {treatments.map((treatment) => {
        const progress = (treatment.usedSessions / treatment.totalSessions) * 100
        return (
            ...
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  ...
                  <CardDescription>
                    Mua ngày: {format(new Date(treatment.purchaseDate), "dd/MM/yyyy", { locale: vi })}
                  </CardDescription>
                </div>

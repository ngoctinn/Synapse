...
function SelectTrigger({
  ...
  return (
    ...
    >
      {startContent && (
        <div className="text-muted-foreground absolute left-4 flex items-center justify-center">
          {startContent}
        </div>
      )}
      {children}
      <div className="flex items-center gap-2 absolute right-4 top-1/2 -translate-y-1/2">
        ...
        <SelectPrimitive.Icon asChild>
          <ChevronDownIcon
            className={cn(
              "size-4 opacity-50",
              props["aria-invalid"] && "text-destructive opacity-100"
            )}
          />

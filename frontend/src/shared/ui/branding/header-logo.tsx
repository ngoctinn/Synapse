...
export function HeaderLogo({ className, textClassName }: HeaderLogoProps) {
  return (
    ...
    >
      <div className="bg-primary text-primary-foreground shrink-0 rounded-full p-1 transition-transform group-hover:scale-110">
        <svg
      ...
      <span
        className={cn(
          "from-primary to-primary/80 hidden truncate bg-gradient-to-r bg-clip-text text-lg font-bold text-transparent sm:inline-block",
          textClassName
        )}
      >
        Synapse

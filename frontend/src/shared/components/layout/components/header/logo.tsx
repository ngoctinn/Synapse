...
export function HeaderLogo({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "shrink-0 rounded-full p-1 transition-transform group-hover:scale-110",
          variant === "inverted"
      ...
      <span
        className={cn(
          "hidden truncate text-lg font-bold sm:inline-block",
          variant === "inverted"
            ? "text-white"
            : "from-primary to-primary/80 bg-gradient-to-r bg-clip-text text-transparent",
          textClassName
        )}
      >
        Synapse

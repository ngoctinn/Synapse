  ...
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight">Xin chào, Lễ tân 👋</h1>
          <p className="text-muted-foreground mt-1">Hôm nay là một ngày bận rộn. Đây là những gì đang diễn ra.</p>
        </div>
        <div className="flex items-center gap-2">
            <Button variant="outline" className="rounded-xl shadow-sm">Báo cáo nhanh</Button>

---
phase: testing
title: Chiến lược Kiểm thử - Project Foundation
description: Xác định cách tiếp cận kiểm thử, các trường hợp kiểm thử và đảm bảo chất lượng cho Project Foundation
---
